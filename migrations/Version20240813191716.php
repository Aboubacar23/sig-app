 ...
 */
final class Version20240813191716 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE camion (id INT AUTO_INCREMENT NOT NULL, numero_camion VARCHAR(255) NOT NULL, chauffeur VARCHAR(255) NOT NULL, model VARCHAR(255) NOT NULL, marque VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE commande_client (id INT AUTO_INCREMENT NOT NULL, client_id INT DEFAULT NULL, code_commande VARCHAR(255) DEFAULT NULL, numero_reference VARCHAR(255) DEFAULT NULL, date_commande DATE DEFAULT NULL, type_commande VARCHAR(255) DEFAULT NULL, etat TINYINT(1) DEFAULT NULL, note LONGTEXT DEFAULT NULL, paiement_date DATE DEFAULT NULL, reception_date DATE DEFAULT NULL, flag TINYINT(1) DEFAULT NULL, frais_livraison DOUBLE PRECISION DEFAULT NULL, INDEX IDX_C510FF8019EB6921 (client_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
